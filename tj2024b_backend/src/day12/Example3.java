...
class Student2{
	private static int serialNum = 1000; // static 변수에 private
	public int studentID;
	public String studentName;
	public int grade;
	public String address;
	...
	public static int getSerialNum() {
		int i = 10;
		// return this.serialNum; // static 변수는 전체 변수이므로 
		return serialNum; 
	}
...
public class Example3 { // class start 
	public static void main(String[] args) {
		...
		// 예4] 
		// Student2.serialNum; // static 변수도 private 외부클래스 접근 불가능
...
/*
  ...
  생성된 멤버변수 8개 :  (studentID , studentName , grade , address) x2
  정적 변수 1개
 * */
