...
public class TestBoardProgram2501155 {
	public static void main(String[] args) {
		...
		while (true) {
			// [2]
			System.out.println("1.입력 2.출력 3.삭제");
			// [3]
			...
			if( choose == 1) {
				...
				if(tbp2501151.title == null) {
					tbp2501151.title = title;
					tbp2501151.content = content;
					tbp2501151.writer = writer;
				} else if(tbp2501152.title == null) {
					tbp2501152.title = title;
					tbp2501152.content = content;
					tbp2501152.writer = writer;
				} else if(tbp2501153.title == null) {
					tbp2501153.title = title;
					tbp2501153.content = content;
